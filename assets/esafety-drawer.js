class EsafetyDrawer extends HTMLElement {
  constructor() {
    ...
    this.overlay = this.querySelector("#cart-overlay") || this.querySelector("#drawer-overlay");
    this.panel = this.querySelector("#cart-drawer") || this.querySelector(".esafety-drawer-panel");
    this.closeButton = this.querySelector("[data-drawer-close]");
    this.cartCount = document.querySelector(".cart-count");
  }

  connectedCallback() {
    if (this.openTrigger) this.openTrigger.addEventListener("click", this.handleOpen.bind(this));
    if (this.closeButton) this.closeButton.addEventListener("click", this.handleClose.bind(this));
  ...
  closeDrawer() {
    ...
    if (this.panel) {
      ...
      if (this.panel.classList.contains('left') || this.panel.classList.contains('-translate-x-full')) {
